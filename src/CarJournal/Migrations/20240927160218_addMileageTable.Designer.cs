...
namespace CarJournal.Migrations
{
    ...
    [Migration("20240927160218_addMileageTable")]
            ...
            modelBuilder.Entity("CarJournal.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Email = "admin",
                            PasswordHash = new byte[] { 182, 84, 109, 205, 72, 58, 89, 19, 54, 164, 37, 44, 57, 155, 57, 145, 66, 114, 127, 31, 14, 105, 192, 202, 203, 168, 119, 174, 99, 60, 70, 119, 93, 100, 239, 114, 136, 169, 79, 225, 102, 4, 174, 118, 107, 69, 44, 74, 129, 47, 221, 38, 66, 151, 244, 171, 190, 1, 241, 151, 179, 187, 79, 52 },
                            PasswordSalt = new byte[] { 231, 249, 0, 201, 254, 38, 189, 203, 21, 164, 153, 43, 223, 50, 44, 116, 199, 254, 174, 206, 78, 229, 95, 95, 43, 88, 251, 182, 31, 231, 89, 255, 120, 158, 63, 52, 121, 166, 99, 117, 190, 230, 201, 43, 72, 10, 223, 46, 218, 51, 181, 56, 49, 248, 33, 27, 61, 120, 250, 144, 151, 181, 132, 246, 223, 173, 252, 16, 199, 193, 98, 55, 23, 98, 226, 142, 216, 5, 147, 110, 145, 106, 117, 27, 74, 193, 164, 79, 175, 28, 71, 73, 11, 177, 140, 194, 87, 102, 205, 160, 235, 57, 10, 141, 226, 81, 85, 246, 214, 174, 68, 168, 155, 79, 145, 63, 2, 131, 58, 106, 184, 29, 160, 17, 104, 208, 200, 13 },
                            RoleId = 2
                        });
                });
